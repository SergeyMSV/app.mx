...
const sc_server_data = require('./server_data.js');
const sc_server_data_gnss = require('./server_data_gnss.js');
...
app.get('/', (req, res) => {
    ...
    if (req.query.content == 'data') {
        ...
        data.uptime = sc_server_data.GetUptime(g_conf.uptime);
        data.gnss = sc_server_data_gnss.GetPageData();
    ...
    HtmlBodyMain += sc_server_data_gnss.GetPage();
    HtmlBodyMain += '</table>';
