...
tUART::tUART(boost::asio::io_context& ioc, tTWREndpoint ep)
...
//std::uint8_t tUART::GetMode()
//{
//	return m_Mode;
//}
//
//bool tUART::SetMode(std::uint8_t val)
//{
//	m_Mode = val;
//	return true;
//}
//
//std::uint8_t tUART::GetBits()
//{
//	return m_Bits;
//}
//
//bool tUART::SetBits(std::uint8_t val)
//{
//	m_Bits = val;
//	return true;
//}
//
//std::uint32_t tUART::GetSpeed()
//{
//	return m_Speed;
//}
//
//bool tUART::SetSpeed(std::uint32_t val)
//{
//	m_Speed = val;
//	return true;
//}
//
//std::vector<std::uint8_t> tUART::Transaction(const std::vector<std::uint8_t>& tx)
//{
...
//{
//
//tUART::tUART(const std::string& id, std::uint8_t mode, std::uint8_t bits, std::uint32_t speed_hz, std::uint16_t delay_us)
//	:m_Delay(delay_us)
//{
