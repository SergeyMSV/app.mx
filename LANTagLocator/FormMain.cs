...
namespace LANTagLocator
{
    public partial class FormMain : Form
    {
        ...
        void Locator()
        {
            ...
            Thread.Sleep(100); // [#] It is here in order to avoid the following exceprion: "Invoke or BeginInvoke cannot be called on a control until the window handle has been created."

            try
            {
                ArrayList AddrsLocal = utils.Network.GetLocalIPAddresses(IPAddress.Parse(Properties.Settings.Default.Network));
