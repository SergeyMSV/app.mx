...
void UDP_ClientTest(std::uint16_t port)
{
	...
	while (true)
	{
		try
		{
			...
			case 1:
			{
				Pack = "{\"cmd\":\"search\",\"family_code\":\"28\"}"; // maybe it's better to repllace with real family code like DS18B20 = 0x28, // Thermometer
				break;
			}
			case 2:
			{
				Pack = "{\"cmd\":\"search\",\"family_code\":\"01\"}"; // maybe it's better to repllace with real family code like DS1990A = 0x01, // iButton
				break;
			}
			case 3:
			{
			...
			case 4:
			{
				Pack = "{\"cmd\":\"write_rom\",\"roms\":[\"01dec4080300002f\",\"01137b1501000030\",\"01606cbf03000021\"]}"; // maybe it's better to repllace with real family code like DS1990A = 0x01, // iButton
				break;
			}
			case 5:
			{
				Pack = "{\"cmd\":\"thermo\",\"roms\":[\"28ff640e7744c86e\",\"28ff640e7747873c\"]}"; // maybe it's better to repllace with real family code like DS1990A = 0x01, // iButton
				break;
			}
			case 6:
			{
